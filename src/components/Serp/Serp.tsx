...
export function SerpBody({ loading, foundProducts, toggleSidebar }: ContentChildrenProps) {
...
export function SerpBodyInfiniteScroll({ loading, foundProducts, toggleSidebar }: ContentChildrenProps) {
