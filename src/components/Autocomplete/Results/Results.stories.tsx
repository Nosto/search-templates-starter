...
export const MockedView: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "The Results component integrates with Nosto's search context to display autocomplete suggestions. This story shows a documentation mockup since the Nosto hooks are not available in Storybook."
      }
    }
  }
}